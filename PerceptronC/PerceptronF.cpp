...
public:
        ...
        : SCount(argSCount), ACount(argACount), RCount(argRCount), th(argTh), rnd(24), dist(0.0f, 1.0f)
    {
        ...
        perceptronC = new PerceptronCuda();
        perceptronC->initialize(SAWeights, SCount, ACount);
    }
    ...
    void AActivation(const float* SField, float* AField) 
    {
        ...
        perceptronC->AActivationCuda(AField, SField, ACount, SCount);
    }
