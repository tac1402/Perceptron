...
public class PerceptronT : IDisposable
{
	private IntPtr _handle;

	[DllImport("PerceptronT.dll", CallingConvention = CallingConvention.Cdecl)]
	...
	public PerceptronT(int argSCount, int argACount, int argRCount, float argTh)
	{
		SCount = argSCount;
		ACount = argACount;
		RCount = argRCount;
