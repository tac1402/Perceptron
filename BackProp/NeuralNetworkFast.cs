...
namespace BackProp
{
	...
	public class NeuralNetworkFast
	{
		...
		private Dictionary<int, double[]> weightsInputHidden;
		private double[] biasHidden;
		private Dictionary<int, double[]> weightsHiddenOutput;
		private double[] biasOutput;

		private readonly Random random;

		public NeuralNetworkFast(int inputSize, int hiddenSize, int outputSize, double learningRate, int seed = 1)
		{
		...
		private void InitializeWeights()
		{
			...
			weightsInputHidden = new Dictionary<int, double[]>();
			biasHidden = new double[hiddenSize];

			for (int i = 0; i < inputSize; i++)
			{
				weightsInputHidden.Add(i, new double[hiddenSize]);
			...
			weightsHiddenOutput = new Dictionary<int, double[]>();
			biasOutput = new double[outputSize];

			for (int i = 0; i < hiddenSize; i++)
			{
				weightsHiddenOutput.Add(i, new double[outputSize]);
